...
from utils import write_json, mturk_not_empty, mturk_extract_size, mturk_process_dialogue, mturk_process_dialogue_turn, mturk_process_json
...
def main():
    ...
    for index, row in tqdm(results.iterrows(), desc="Processing results", total=len(results)):
        result = {
            ...
            "summary": mturk_process_dialogue_turn(row["Input.summary"]),
